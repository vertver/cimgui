...
//based on imgui.h file version "1.91.1 WIP" 19101 from Dear ImGui https://github.com/ocornut/imgui
...
CIMGUI_API void ImDrawList_AddConvexPolyFilledMultiColor(ImDrawList* self,const ImVec2* points,int num_points,ImU32 col0,ImU32 col1,ImU32 col2,ImU32 col3,ImDrawBlendMode blending)
{
    return self->AddConvexPolyFilledMultiColor(points,num_points,col0,col1,col2,col3,blending);
}
